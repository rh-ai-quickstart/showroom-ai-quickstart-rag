...
image:https://img.shields.io/github/v/release/rh-ai-quickstart/RAG[GitHub release,link=https://github.com/rh-ai-quickstart/RAG/releases]
image:https://img.shields.io/badge/quay.io-llamastack--dist--ui-blue[Quay.io,link=https://quay.io/repository/rh-ai-quickstart/llamastack-dist-ui]
